package io.tince.advanced.java.streams.operations.intermediate;
...
public class IntermediateOperations {
    ...
    public static void doSortedOther() {
        ...
        Stream.of("Tim", "Jim", "Peter", "Ann", "Mary").peek(name -> System.out.print(" 0." + name))    // Tim, Jim, Peter, Ann, Mary
                .filter(name -> name.length() == 3).peek(name -> System.out.print(" 1." + name))    // Tim, Jim, Ann
                .sorted()                                      // Tim, Jim, Ann (stored)
                .peek(name -> System.out.print(" 2." + name))    // Ann, Jim
                .limit(2).forEach(name -> System.out.print(" 3." + name));// Ann, Jim
    ...
    public static void doSorted2() {
        ...
        Stream.of(mary, john)
                ...
                .sorted(Comparator.comparing(p -> p.getAge())).forEach(System.out::print);
    ...
    public static void doSortedFromBook() {
        ...
        Stream.of("Toby", "Anna", "Leroy", "Alex").peek(s -> System.out.print(" 0." + s)).filter(s -> s.length() == 4).peek(s -> System.out.print(" 1." + s)) // no Leroy
                .sorted() // stores Toby, Anna and Alex
                .peek(s -> System.out.print(" 2." + s)).limit(2).forEach(s -> System.out.print(" 3." + s));// no Toby
    ...
    public static void doFlatMap() {
        ...
        streamOfLists.flatMap(list -> list.stream()).forEach(System.out::print);// seandesmondmaryann
    }
    ...
    public static void doMap() {
        ...
        Stream.of("book", "pen", "ruler").map(s -> s.length()) // String::length
    ...
    public static void doLimit() {
        ...
        Stream.of(11, 22, 33, 44, 55, 66, 77, 88, 99).peek(n -> System.out.print(" A - " + n)).filter(n -> n > 40).peek(n -> System.out.print(" B - " + n)).limit(2).forEach(n -> System.out.print(" C - " + n));
    }
    ...
    public static void doDistinct() {
        ...
        Stream.of("eagle", "eagle", "EAGLE").peek(s -> System.out.print(" 1." + s)).distinct().forEach(s -> System.out.print(" 2." + s));
    ...
    public static void doFilter() {
        ...
        Stream.of("galway", "mayo", "roscommon").filter(countyName -> countyName.length() > 5).forEach(System.out::print);// galwayroscommon
    }
